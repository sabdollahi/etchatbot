import enchant,grammar_check
import enchant.checker
from enchant.checker.CmdLineChecker import CmdLineChecker
spell_check = enchant.checker.SpellChecker("en_US")
grammarC = grammar_check.LanguageTool('en_US')
userInput = ""
NofChoice = 3
while userInput != "exit":
	...
	for serror in spell_check:
		...
		while userCorrect not in range(0,NofChoice) and q<len(suggest):
			...
			try:
				userCorrect = raw_input("Correct number: ")
	...
	for gerror in matches:
		...
		print gerror.msg
	print "Correct sentence : " + grammar_check.correct(Grammartext, matches)